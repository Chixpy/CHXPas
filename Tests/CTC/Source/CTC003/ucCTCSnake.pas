...
function cCTCSnake.Eat(const Food : TPoint) : Boolean;
var
  p : TPoint;
begin
...
procedure cCTCSnake.Dir(const ax, ay : integer);
begin
  self.xspeed := ax;
  self.yspeed := ay;
end;

procedure cCTCSnake.Death;
var
  i : integer;
  p : TPoint;
begin
