...
begin
  ...
  begin
    ...
    Render.RegPolyCCFilled(kRenderW div 2, kRenderW div 2, Radius, NSides,
      Angle);
  end
  else
    Render.RegPolyCC(kRenderW div 2, kRenderW div 2, Radius, NSides,
      Color1, Color2, Angle);
  ...
  case aEvent.type_ of
    ...
    begin
      ...
      case aEvent.key.key of
        ...
        SDLK_DOWN: if Radius > 1.5 then Radius -= 1.5;
