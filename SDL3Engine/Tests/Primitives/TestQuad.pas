...
begin
  ...
  begin
    ...
    case DrawMode of
      dmDefault : Render.QuadBorder(Points);
      dmSubPixel : Render.SPQuadBorder(Points);
      // dmFullPixel : Render.FPQuadBorder(PointsInt);
    end;
  end;
  ...
  begin
    ...
    case DrawMode of
      dmDefault : Render.QuadFilled(Points);
      dmSubPixel : Render.SPQuadFilled(Points);
      // dmFullPixel : Render.FPQuadFilled(PointsInt);
    end;
  end;

  if (FillMode = fmBorFill) or (FillMode = fmAll) then
    case DrawMode of
      dmDefault : Render.Quad(Points, BorderColor, FillColor);
      dmSubPixel : Render.SPQuad(Points, BorderColor, FillColor);
      // dmFullPixel : Render.FPQuad(PointsInt, BorderColor, FillColor);
    end;
