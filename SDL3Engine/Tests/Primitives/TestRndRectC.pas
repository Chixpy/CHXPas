...
begin
  ...
  begin
    ...
    case DrawMode of
      // dmDefault :
      // begin
      //   Render.RndRectCBorder(Rect, Radius);
      //   if ShowGuide then
      //   begin
      //     Render.SetDrawColor(1, 0.2);
      //     Render.RectBorder(Rect);
      //     Render.CircleBorder(CenterX, CenterY, Radius);
      //   end;
      // end;

      dmSubPixel :
      begin
        Render.SPRndRectCBorder(Rect, Radius);
        if ShowGuide then
        begin
          Render.SetDrawColor(1, 0.2);
          Render.SPRectBorder(Rect);
          Render.SPCircleBorder(CenterX, CenterY, Radius);
        end;
      end;

      // dmFullPixel :
      // begin
      //   Render.FPRndRectCBorder(Rect, Radius);
      //   if ShowGuide then
      //   begin
      //     Render.SetDrawColor(1, 0.2);
      //     Render.FPRectBorder(Rect);
      //     Render.FPCircleBorder(CenterX, CenterY, Radius);
      //   end;
      // end;
    end;
  end;
  ...
  begin
    ...
    case DrawMode of
      // dmDefault :
      // begin
      //   Render.RndRectCFilled(Rect, Radius);
      //   if ShowGuide then
      //   begin
      //     Render.SetDrawColor(1, 0.2);
      //     Render.RectFilled(Rect);
      //     Render.CircleFilled(CenterX, CenterY, Radius);
      //   end;
      // end;

      dmSubPixel :
      begin
        Render.SPRndRectCFilled(Rect, Radius);
        if ShowGuide then
        begin
          Render.SetDrawColor(1, 0.2);
          Render.SPRectFilled(Rect);
          Render.SPCircleFilled(CenterX, CenterY, Radius);
        end;
      end;

      // dmFullPixel :
      // begin
      //   Render.FPRndRectCFilled(Rect, Radius);
      //   if ShowGuide then
      //   begin
      //     Render.SetDrawColor(1, 0.2);
      //     Render.FPRectFilled(Rect);
      //     Render.FPCircleFilled(CenterX, CenterY, Radius);
      //   end;
      // end;
    end;
  end;
  ...
  if (FillMode = fmBorFill) or (FillMode = fmAll) then
    case DrawMode of
      // dmDefault :
      // begin
      //   Render.RndRectC(Rect, Radius, BorderColor, FillColor);
      //   if ShowGuide then
      //   begin
      //     Render.Rect(Rect, SDLFColor(1, 0.2), SDLFColor(1, 0.4));
      //     Render.Circle(CenterX, CenterY, Radius,
      ...
      dmSubPixel :
      begin
        Render.SPRndRectC(Rect, Radius, BorderColor, FillColor);
        if ShowGuide then
        begin
          Render.SPRect(Rect, SDLFColor(1, 0.2), SDLFColor(1, 0.4));
          Render.SPCircle(CenterX, CenterY, Radius,
            SDLFColor(1, 0.2), SDLFColor(1, 0.4));
        end;
      end;
      ...
      // dmFullPixel :
      // begin
      //   Render.FPRndRectC(RectInt, Radius, BorderColor, FillColor);
      //   if ShowGuide then
      //   begin
      //     Render.SetDrawColor(1, 0.2);
      //     Render.FPRect(RectInt, SDLFColor(1, 0.2), SDLFColor(1, 0.4));
      //     Render.FPCircle(CenterX, CenterY, Radius,
      //       SDLFColor(1, 0.2), SDLFColor(1, 0.4));
      //   end;
      // end;
    end;
...
begin
  ...
  Render.DebugTextF(0, 10, 'DiamX = %.4g DiamY = %.4g Radius = %.4g',
