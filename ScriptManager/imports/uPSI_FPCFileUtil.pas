...
// Helper functions
// ----------------
procedure CHXFindAllFiles(AList: TStrings; const SearchPath: string; SearchMask: string; SearchSubDirs: Boolean);
begin
...
begin
  ...
  CL.AddDelphiFunction('function ExtractFileNameWithoutExt(const AFilename: string): string;');
  ...
  CL.AddDelphiFunction('procedure FindAllFiles(AList: TStrings; const SearchPath: string; SearchMask: string; SearchSubDirs: boolean);');
...
begin
  ...
  S.RegisterDelphiFunction(@DirectoryExistsUTF8, 'DirectoryExists', cdRegister);
  S.RegisterDelphiFunction(@FileExistsUTF8, 'FileExists', cdRegister);
  S.RegisterDelphiFunction(@ForceDirectoriesUTF8, 'ForceDirectories', cdRegister);
  ...
  S.RegisterDelphiFunction(@CHXFindAllDirectories, 'FindAllDirectories', cdRegister);
