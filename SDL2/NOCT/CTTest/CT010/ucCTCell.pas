...
type
  ...
  public
    ...
    function CheckNeighbors(Grid : TCellList) : cCTCell;

    constructor Create(ii, jj : integer);
    destructor Destroy; override;
  end;

  TGenCellList = specialize TFPGObjectList<cCTCell>;
  ...
  public
    ...
    function Cellidx(i, j : integer) : cCTCell;
  end;
...
function cCTCell.CheckNeighbors(Grid : TCellList) : cCTCell;
var
  Neighbors : TCellList;
  Top, Right, Bottom, Left : cCTCell;
begin
...
constructor cCTCell.Create(ii, jj : integer);
begin
...
function TCellList.Cellidx(i, j : integer) : cCTCell;
begin
